...
<!-- @ref https://github.com/ccheever/llp/blob/v0.5.1/llp/0010.002-ship.spec.md — the gates, authority model, and delivery semantics this pins -->
<!-- @ref https://github.com/ccheever/llp/blob/v0.5.1/llp/0004-design-principles.principles.md — co-evolution: docs and @refs land in the same commits -->
