...
<!-- @ref https://github.com/ccheever/llp/blob/v0.5.0/llp/0000-linked-literate-programming.explainer.md#review-honesty — the rules this enforces -->
<!-- @ref https://github.com/ccheever/llp/blob/v0.5.0/llp/0005-rfc-process.guide.md#review-artifacts — artifact + provenance header format -->
